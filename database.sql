-- ====================================================================================
-- SMART PLANNER - PRO DATABASE SCRIPT
-- Platform: SQL Server
...
BEGIN
    -- Preferences (Note: Using reminder_minutes as per this script's schema)
    INSERT INTO study_preferences (user_id, plan_start_date, plan_end_date, max_hours_per_day, allowed_days, reminder_minutes)
    VALUES (@UserId, CAST(GETDATE() AS DATE), CAST(DATEADD(month, 3, GETDATE()) AS DATE), 4.00, 'MON,TUE,WED,THU,FRI,SAT', 30);
